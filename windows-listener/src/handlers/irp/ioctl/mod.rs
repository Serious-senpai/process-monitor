...
use wdk_sys::{
    DEVICE_OBJECT, FILE_ANY_ACCESS, FILE_DEVICE_UNKNOWN, IO_STACK_LOCATION, IRP,
    IRP_MJ_DEVICE_CONTROL, METHOD_BUFFERED, STATUS_INVALID_DEVICE_REQUEST,
};
...
pub const IOCTL_MEMORY_CLEANUP: u32 =
